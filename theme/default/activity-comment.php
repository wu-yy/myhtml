<div class="comment" id="comment">
                        ...
                        <?php if($date->user) : ?>
                        <form method="post" action="<?php echo $date->siteUrl; ?>/engine/action/activityComment.php" class="comment-form">
                        ...
                        <div class="modal fade" id="commentReplyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="<?php echo $date->siteUrl; ?>/engine/action/activityComment.php">
                                        <input type="hidden" name="id" value="<?php echo $date->activity->id; ?>" />
